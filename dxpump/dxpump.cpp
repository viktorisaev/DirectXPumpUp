...
HRESULT InitDevice()
{
	...
	g_pImmediateContext->OMSetRenderTargets(1, &g_pRenderTargetView, nullptr/*depthstensil*/);
...
void Render()
{
	...
	g_pImmediateContext->ClearRenderTargetView(g_pRenderTargetView, (nFrame % 2 == 0) ? Colors::MidnightBlue : Colors::Bisque);
	nFrame += 1;
